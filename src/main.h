...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 CIRC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 CIRC mininput
...
public:
    ...
    {
        uint256 thash;
	hashspinfinal(BEGIN(nVersion), nNonce, BEGIN(thash));	
